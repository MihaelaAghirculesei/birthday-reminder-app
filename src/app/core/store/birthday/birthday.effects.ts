...
export class BirthdayEffects {
  ...
  private generateTestData(): Birthday[] {
    const testNames = [
      ...
      { name: 'Maya Patel', date: new Date(1993, 1, 28), category: 'family', photo: 'https://i.pravatar.cc/200?img=21' },
      ...
      { name: 'Jessica Parker', date: new Date(1989, 6, 30), category: 'friends', photo: 'https://i.pravatar.cc/200?img=40' },
