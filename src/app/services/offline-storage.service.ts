...
export class IndexedDBStorageService implements OfflineStorageService {
  ...
  async getBirthdays(): Promise<Birthday[]> {
    try {
      ...
      console.error('Error getting birthdays from IndexedDB:', error);
      return [];
    }
  }
  ...
  async saveBirthdays(birthdays: Birthday[]): Promise<void> {
    try {
      ...
      console.error('Error saving birthdays to IndexedDB:', error);
      throw error;
    }
  }
  ...
  async addBirthday(birthday: Birthday): Promise<void> {
    try {
      ...
      console.error('Error adding birthday to IndexedDB:', error);
      throw error;
    }
  }
  ...
  async updateBirthday(birthday: Birthday): Promise<void> {
    try {
      ...
      console.error('Error updating birthday in IndexedDB:', error);
      throw error;
    }
  }
  ...
  async deleteBirthday(id: string): Promise<void> {
    try {
      ...
      console.error('Error deleting birthday from IndexedDB:', error);
      throw error;
    }
  }
